...
class MessagesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Messages']))
		{
            ...
            if($model->save()){
                $model->image_path->saveAs(dirname(__FILE__).'/../../images/'.$model->image_path->name);			    
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Messages']))
		{
            unset($_POST['Messages']['image_path']);
			$model->attributes=$_POST['Messages'];
          
            $imagePath=CUploadedFile::getInstance($model,'image_path');
            if($imagePath !== null){
