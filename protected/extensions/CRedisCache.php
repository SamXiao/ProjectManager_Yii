...
/**
 * CRedisCache uses phpredis client as redis php client{@link https://github.com/nicolasff/phpredis phpredis}.
 */
class CRedisCache extends CCache
{
	...
	public function getRedis()
	{
		if($this->_cache!==null)
            ...
            Yii::log('Opening Redis connection');
            $this->_cache=new Redis();
            $this->_cache->connect($this->servers["host"], $this->servers["port"]);
			return $this->_cache;
        }
	}
